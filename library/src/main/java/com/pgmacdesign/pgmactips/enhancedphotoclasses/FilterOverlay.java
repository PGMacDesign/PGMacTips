...
public class FilterOverlay <T extends FilterOverlay.Graphic> extends View {
     ...
     * graphics element.  Add instances to the overlay using {@link FilterOverlay#add(Graphic)}
     */
    public static abstract class Graphic {
        private FilterOverlay mOverlay;

        public Graphic(FilterOverlay overlay) {
            mOverlay = overlay;
        }
    ...
    public FilterOverlay(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (FilterOverlay.Graphic graphic : mGraphics) {
            graphic.draw(canvas);
        }
        /*
        synchronized (mLock) {
