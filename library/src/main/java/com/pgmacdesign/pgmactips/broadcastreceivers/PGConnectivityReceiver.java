...
public class PGConnectivityReceiver extends BroadcastReceiver {
     ...
     * Thanks to: https://stackoverflow.com/questions/3841317/how-do-i-see-if-wi-fi-is-connected-on-android
     */
    @Override
    ...
    public void onReceive(Context context, Intent arg1) {
	    ...
	    WifiManager wifiMgr = (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N
	    ...
	    final NetworkInfo mWifi = cm.getNetworkInfo(ConnectivityManager.TYPE_WIFI);
	    if(connectivityReceiverListeners != null){
			    ...
			    for(Map.Entry<String, ConnectivityReceiverListener> map : connectivityReceiverListeners.entrySet()){
				    ...
				    if (connectivityReceiverListener != null) {
					    ...
					    if(Build.VERSION.SDK_INT >= 23){
						    if(wifiInfo != null){
							    boolean isWifiConnected = (wifiInfo.getNetworkId() != -1);
							    connectivityReceiverListener.isWifiConnected(isWifiConnected);
						    }
					    } else {
						    if (mWifi != null) {
							    connectivityReceiverListener.isWifiConnected(mWifi.isConnected());
						    }
					    }
				    }
			    }
