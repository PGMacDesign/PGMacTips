...
D: Deleting entire database!
D: You cannot modify this table from that method. If you want to access the MasterDatabaseObject table, please use the persistObject / dePersistObject / getPersistedObject / getAllPersistedObjects method calls.
D: If you want to clear all stored / persisted data, please call deleteAllPersistedObjects(true, false)
W: java.lang.IllegalStateException: It's not allowed to delete the file associated with an open Realm. Remember to close() all the instances of the Realm before deleting its file: /data/data/kajabi.kajabiapp/files/kajabiherouni.db
W:     at io.realm.BaseRealm.deleteRealm(BaseRealm.java:624)
W:     at io.realm.Realm.deleteRealm(Realm.java:1676)
W:     at com.pgmacdesign.pgmactips.utilities.DatabaseUtilities.deleteRealmFileInStorage(DatabaseUtilities.java:1154)
W:     at com.pgmacdesign.pgmactips.utilities.DatabaseUtilities.deleteEntireDB(DatabaseUtilities.java:1139)
			 */
