 ...
 */
public class EncryptionUtilitiesV2 {
     ...
     * @return a tuple of the IV, ciphertext, mac. {@link CipherTextIvMac}
    ...
    public static CipherTextIvMac encrypt(String plaintext, SecretKeys secretKeys)
        ...
        return encrypt(plaintext, secretKeys, EncryptionUtilitiesV2.getUTF8());
    }
    ...
    public static String decryptString(CipherTextIvMac civ, SecretKeys secretKeys)
            throws UnsupportedEncodingException, GeneralSecurityException {
        return decryptString(civ, secretKeys, EncryptionUtilitiesV2.getUTF8());
    }
     ...
     */
    public static byte[] generateRandomSalt() throws GeneralSecurityException {
     ...
     * Initialization Vectors are arbitrary numbers used for data encryption
     ...
     * @return true if the arrays are exactly equal. Will return false if they are not or either is null / empty
     */
    public static boolean constantTimeEq(byte[] array1, byte[] array2) {
    ...
    /**
     * Generate random bytes within a certain length
     * @param length Length to get array of
    ...
    /**
     * Copy the elements of a byte array from the specified start to the end
     *
    ...
    public static class SecretKeys {
        ...
        public boolean equals(Object obj) {
            ...
            if (getClass() != obj.getClass())
                return false;
            EncryptionUtilitiesV2.SecretKeys other = (EncryptionUtilitiesV2.SecretKeys) obj;
    ...
    public static class CipherTextIvMac {
        ...
        /**
         * Constructor for use with Base64 Strings
    ...
    public static final class PrngFixes {
        ...
        private static byte[] getBuildFingerprintAndDeviceSerial() {
            ...
            try {
                return result.toString().getBytes(EncryptionUtilitiesV2.getUTF8());
