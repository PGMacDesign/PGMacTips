...
public class EncryptionUtilities {
    ...
    public static CipherTextIvMac encrypt(String plaintext, SecretKeys secretKeys)
        ...
        return encrypt(plaintext, secretKeys, EncryptionUtilities.getUTF8());
    }
    ...
    public static String decryptString(CipherTextIvMac civ, SecretKeys secretKeys)
            throws UnsupportedEncodingException, GeneralSecurityException {
        return decryptString(civ, secretKeys, EncryptionUtilities.getUTF8());
    }
    ...
    public static class SecretKeys {
        ...
        public boolean equals(Object obj) {
            ...
            if (getClass() != obj.getClass())
                return false;
            EncryptionUtilities.SecretKeys other = (EncryptionUtilities.SecretKeys) obj;
    ...
    public static final class PrngFixes {
        ...
        private static byte[] getBuildFingerprintAndDeviceSerial() {
            ...
            try {
                return result.toString().getBytes(EncryptionUtilities.getUTF8());
