...
public class EncryptionUtilities {
	 ...
	 * Upped to 10,000 as per article: https://cryptosense.com/blog/parameter-choice-for-pbkdf2/
	 */
	...
	private static SecurityLevel securityLevel = SecurityLevel.LOW;
	...
	/**
	 * Set the security level and adjust the amount of entropy generated in Encrypted values
	 * @param securityLevel {@link EncryptionUtilities.SecurityLevel}
	 */
	public static void setSecurityLevel(@NonNull SecurityLevel securityLevel){
		EncryptionUtilities.securityLevel = (securityLevel == null) ? SecurityLevel.LOW : securityLevel;
	}
	...
	private static SecretKey deriveAesKey(char[] password, byte[] salt, int keyLen)
		...
		KeySpec spec = new PBEKeySpec(password, salt, securityLevel.iterations, keyLen);
...
//        random.nextBytes(salt);
	...
	//region Security Level Enum
	
	/**
	 * This will adjust the amount of entropy generated in each encryption. A higher level security
	 * will loop through more iterations with regards to the PBKDF2_ITERATIONS variable.
	 * Note that higher security measures may take longer to run computational operations
	 * For more info, see this link: https://cryptosense.com/blog/parameter-choice-for-pbkdf2/
	 */
