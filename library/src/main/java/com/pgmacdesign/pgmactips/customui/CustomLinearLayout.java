...
/**
 * A custom Linear layout built to include the option to customize the height and width including the
...
public class CustomLinearLayout extends LinearLayout {
	...
	public CustomLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
