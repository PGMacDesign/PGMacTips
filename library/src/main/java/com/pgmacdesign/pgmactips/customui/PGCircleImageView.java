...
/**
 * A Circular image view frame that can have both a surrounding color stroke as well as customized click overlay
 * Code from https://medium.com/@abdularis/android-custom-view-tutorial-create-circle-image-view-cacdd3e986cb
 */
public class PGCircleImageView extends AppCompatImageView {
	...
	public PGCircleImageView(Context context) {
		super(context);
		this.init(context, null);
	}
	
	public PGCircleImageView(Context context, @Nullable AttributeSet attrs) {
		super(context, attrs);
		this.init(context, attrs);
	}
	
	public PGCircleImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
	...
	private void init(Context context, AttributeSet attrs){
		...
		if (attrs != null) {
			TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PGCircleImageView, 0, 0);
			
			strokeColor = a.getColor(R.styleable.PGCircleImageView_strokeColor, Color.TRANSPARENT);
			strokeWidth = a.getDimensionPixelSize(R.styleable.PGCircleImageView_strokeWidth, 0);
			highlightEnable = a.getBoolean(R.styleable.PGCircleImageView_highlightEnable, true);
			highlightColor = a.getColor(R.styleable.PGCircleImageView_highlightColor, DEF_PRESS_HIGHLIGHT_COLOR);
		...
		this.mPressedPaint.setColor(highlightColor);
