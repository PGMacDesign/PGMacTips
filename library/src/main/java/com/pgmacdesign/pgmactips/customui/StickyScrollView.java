...
/**
 * Sticky Scroll view where the top section stays when the user scrolls down.
 * Credit to Emil Sjolander - sjolander.emil@gmail.com for creating this
...
public class StickyScrollView  extends ScrollView {
    ...
    /**
     * Notify that the sticky attribute has been added or removed from one or more
