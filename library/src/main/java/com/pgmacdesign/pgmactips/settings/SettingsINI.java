...
/**
 * Wrapper class to write and read a settings file (.ini) to a local data storage.
 */
public class SettingsINI <T extends Object> {

//    public final static String FILENAME = "setting.ini";
//
//    public static <T extends Object> boolean saveCommSettingToFile(final String fileName, final Map<String, T> commsetting) {
//        IniFile ini;
...
//        bDone &= ini.write(TagHost, commsetting.getHost());
...
//        commsetting.setTimeOut(StringUtilities.isNullOrEmpty(ini.read(TagTimeout, Deft))
//                ? "500" : ini.read(TagTimeout, Deft));
...
//        commsetting.setHost(ini.read(TagHost, Deft));
...
//    public static final int MAX_INI_FILE_SIZE  = (int)(PGMacTipsConstants.ONE_MEGABYTE);
//
//    private String fileName;
//    private String m_section;
//
//
//    public IniFile(final String fileName2) {
//        this.fileName = fileName2;
//
//        File fconfig = new File(this.fileName);
//        if (fconfig.exists()) {
//            try {
//                //Info on chmod 666 - https://superuser.com/questions/295591/what-is-the-meaning-of-chmod-666
//                String command = "chmod 666 " + this.fileName;
//                Runtime runtime = Runtime.getRuntime();
//                runtime.exec(command);
//            }catch(IOException e) {
//                L.m("chmod 666 failed!");
//            }
//        } else {
//            try {
...
//
//
//    public boolean write(final String key, final T value) {
//        return (write_profile_string(m_section,key,value,fileName)==1);
//    }
//
//    public T read(final String key, final String default_value) {
//        StringBuffer buf=new StringBuffer(4096);
//        read_profile_string(m_section,key,buf,buf.capacity(),default_value,fileName);
//        return buf.toString();
//    }
//    public int read(final String key, int default_value) {
//        return read_profile_int(m_section,key,default_value,fileName);
//    }
//
...
//    }
//
//    private static int parse_file(final String section, final String key, final String buf,
//                                  int sec_s[], int sec_e[],
//                                  int key_s[], int key_e[],
