...
public class FacebookDataObject {
    ...
    public void setFacebookFriendsData(List<FacebookFriendsListObject> facebookFriendsData) {
        this.facebookFriendsData = facebookFriendsData;
    }
...
//    }
    ...
    */
    ...
    public static class FacebookFriendsListObjectParsingData {
        ...
        public void setData(FacebookFriendsListObject[] data) {
            this.data = data;
        }
    }
