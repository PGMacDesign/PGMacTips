...
* New: New method in the [FileUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/FileUtilities.java) class that allows users to check if the owner of the device has enabled auto rotation.
* New: New methods in the [StringUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/StringUtilities.java) class that add in regex functionality to split URL Query Strings into maps. 

Version 1.5.2 *(2021-08-10)*
---------------------

* Update: Updates to the [RecyclerArrayAdapter](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/adapters/RecyclerArrayAdapter.java) class to add more utility functions and better error handling for scenarios where a bad position or item is sent as a argument.
* Update: Update in the [FileUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/FileUtilities.java) class to allow for byte[] file writes. Also added in a FileDownloader Util
* New: The [FileMover](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/misc/FileMover.kt) class has been added and will copy files from one directory to another

Version 1.5.1 *(2021-07-04)*
---------------------

* New: New methods in the [FileUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/FileUtilities.java) class for determining the Mimetype of a file
* Bugfix: Fixed a bug that could cause a NPE if a PGAnimatedSvgView is set but not initialized properly.
* New: Created a new package for live data utilities and 2 simple classes, [AbsentLiveData](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/livedatautils/AbsentLiveData.kt) and [DynamicLiveData](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/livedatautils/DynamicLiveData.kt). These 2 classes are used to return an object with either null or the passed object so it can be returned along a LiveData approach.
* New: Added in a utilities class [ObjectGsonParceler](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/networkclasses/ObjectGsonParceler.java) that provides Gson-wrapper functionality to the Android Parceler class.
* New: Added a new method to the [AppLockdownUtils](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/AppLockdownUtils.java) class for determining if the app is locked down / a device admin.
* Update: Updated the [RecyclerArrayAdapter](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/adapters/RecyclerArrayAdapter.java) class to change the default constructor to public.

Version 1.4.8 *(2021-02-25)*
---------------------

* Update: Added a new method in the [StackManager] class to allow to remove 1 or more stack items without using the `pop` functionality.
* New: New methods in the [MiscUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/MiscUtilities.java) class for determining if the device running is an emulator or not.
* New: New Class, [RecyclerArrayAdapter](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/adapters/RecyclerArrayAdapter.java), to allow for a simple `listview` approach to a Recyclerview with a wrapper with generics for access.

Version 1.4.6 *(2021-01-01)*
---------------------

* New: New Overloaded methods in the [ImageUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/ImageUtilities.java) to allow for setting images with Android Uris instead of only Strings.

Version 1.4.5 *(2020-12-22)*
---------------------

* New: New methods in the [StringUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/StringUtilities.java) class to work with Spannable Strings which are useful in highlighting text.
* New: Added in a new method for alpha augmentation in the [ColorUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/ColorUtilities.java) class.
* New: Added in a new method into the [DateUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/DateUtilities.java) that is used for a shorter date String calculation on the `how long ago` method. 

Version 1.4.4 *(2020-12-08)*
---------------------

* Update: Updated some of the methods in the [GUIUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/GUIUtilities.java) to allow for dismissing a keyboard and not just showing it. Also added in an overloaded `hideKeyboard` method using context + a View.
* New: New methods in the [ImageUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/ImageUtilities.java) to allow for setting the Image View Color using tint logic. Also added in a method to determine if a passed color argument is a valid resource. 
* New: New overloaded methods in the [AnimationUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/AnimationUtilities.java) to allow users to pass a callback listener whenever the animation completes. 

Version 1.4.3 *(2020-09-22)*
---------------------

* Update: Updated and renamed the [StackRawManager](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/stackmanagement/StackRawManager.java) (Formally StackStringsManager) so that it can use all raw types. It now supports Strings, Longs, Integers, and Doubles.  

Version 1.4.0 *(2020-09-16)*
---------------------

* New: New methods in the [MiscUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/MiscUtilities.java) class to get the size of lists / maps via a safe null check. 
* New: New methods in the [ImageUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/ImageUtilities.java) and [FileUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/FileUtilities.java) classes to be used in conjunction with downloading images from the internet and converting them to a byte array. Also added image rotation methods for simple animation changes.
* New: New methods in the [NetworkingUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/networkclasses/NetworkingUtilities.java) class that allows a really simple builder of an OkHttp3 Client for use in various web-related calls or in the above Image Downloading logic.  
* New: New method in the [TextField Utilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/TextFieldUtilities.java)  class to allow for setting a TextView to have copy / paste functionality (IE, to be able to select and copy from it)
* New: New class, [AppThreadPool](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/AppThreadPool.java). This class is designed to perform operations on either background or foreground threads depending on the end goal. All items from the ThreadUtilities have been moved to this new class as well.

Version 1.3.4 *(2020-09-04)*
---------------------

* New: The [L](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/L.java) class will now allow Exceptions / Throwables to be passed in via the `L.e()` method. This will print the stacktrace instead of casting into a String and printing. The `L.m()` method has also been altered to check the type of this object and if it is an instance of a `Throwable` it will pass it to this new method. 
* Update: Updated the [DisplayManagerUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/DisplayManagerUtilities.java) print out method to also return the String being printed out for use in debugging / debug emails. 
* New: New methods in the [ColorUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/ColorUtilities.java) class that allows for a quick building of ColorStateList(s). 
* New: Adding in new methods to the [ImageUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/ImageUtilities.java) class for setting different image transformations. Also added in a new custom dependency for the Picasso Image Transformations.

Version 1.3.2 *(2020-08-14)*
---------------------

* Bugfix: Fixed an issue where the [RetryCallAdapterFactory](https://github.com/PGMacDesign/PGMacTips/blob/343cc8d690db35205e394595d4fd745f6b27c41c/library/src/main/java/com/pgmacdesign/pgmactips/networkclasses/retrofitutilities/RetryCallAdapterFactory.java) was causing failed calls to run an infinite loop if an invalid number is passed in.  
* New: Added a new method in the [MiscUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/MiscUtilities.java) to allow a simple check for whether or not airplane mode is on.  

Version 1.3.1 *(2020-04-20)*
----------------------------

* Bugfix: Fixed an issue where the [RetrofitParser](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/networkclasses/retrofitutilities/RetrofitParser.java) was sending back double returns which was causing issues.

Version 1.3.0 *(2020-04-15)*
----------------------------

* Update: Updated the Build.gradle to support Obfuscation via parent declarations as per [this](https://stackoverflow.com/a/31031491/2480714) recommendation.
* Update: Updated the [DatabaseUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/DatabaseUtilities.java) class to utilize generics more efficiently so that all non Collection-based return types will no longer require casting. `(Note that returning collections of items like Map<String, Object> from the getPersistedObject() methods will still require casting and will still give a lint warning of an unchecked cast)`
* Update: Updated the `buildToolsVersion` to 29 in the gradle file. 
* Update: Fixed a typo in the [NumberUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/NumberUtilities.java) class that was causing casting to be done when it should not have been.
* Update: Updated the [FileUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/utilities/FileUtilities.java) class to update the byte --> conversion methods so as to properly follow the Order of Operations.
* Update: Update to the response Objects / Tags in the [RetrofitParser](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/networkclasses/retrofitutilities/RetrofitParser.java) class that changes return types. _NOTE! This is a breaking change!_ Added in a new return integer tag, `TAG_RETROFIT_CALL_ERROR_OLD` which returns the older String type from before where the new return object is of type `Throwable` and uses the tag `TAG_RETROFIT_CALL_ERROR`. TLDR, either cast return objects with a tag of `TAG_RETROFIT_CALL_ERROR` into Throwable objects or switch and use the `TAG_RETROFIT_CALL_ERROR_OLD` tag to maintain working String return types. As a result of this change, I have also removed the 4 `.printStackTrace()` calls that were originally in the class so that you can throw / read them yourself and not have them auto print to the logcat.
* New: Added a new class, [RetryCallAdapterFactory](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/networkclasses/retrofitutilities/RetryCallAdapterFactory.java) that is used in conjunction with Retrofit, Specifically the [RetrofitClient](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/networkclasses/retrofitutilities/RetrofitClient.java) class to have better retry logic.
* New: Added a new class, [NetworkingUtilities](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/networkclasses/NetworkingUtilities.java) That will be used for misc networking methods and boilerplate code. As of now, currently has code to check DNS status.
* Update: Updated the Following Dependencies: `Retrofit`, `Retrofit-Converter-Gson`, `OkHttp`, `OkHttp-Logging-Interceptor`, `Okio`, and `Gson`. Also updated the [CustomAnnotationsBase](https://github.com/PGMacDesign/PGMacTips/blob/master/library/src/main/java/com/pgmacdesign/pgmactips/misc/CustomAnnotationsBase.java) with said dependency links.
