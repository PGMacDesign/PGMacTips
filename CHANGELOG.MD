...
* New: New class, [AppThreadPool](tbd). This class is designed to perform operations on either background or foreground threads depending on the end goal. All items from the ThreadUtilities have been moved to this new class as well.
